			...
			{#each $collectionsSorted as col}
				<button
					...
					class="{$selectedCollection === col.collection
						...
						: 'bg-white dark:bg-gray-800 dark:text-gray-400'} my-auto h-7 rounded-lg px-2 py-1 text-xs font-medium shadow transition duration-200 ease-in-out hover:bg-gray-800 hover:text-white dark:border-gray-700 dark:hover:bg-gray-800"
